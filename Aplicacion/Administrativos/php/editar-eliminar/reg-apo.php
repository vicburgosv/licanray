	...
	<body>
		<main id="contenedor_left">
			...
			<div>
				...
				<h2>Formulario de registro de apoderados</h2>
				<form method="get" action="accion/actualizar_apoderado.php">
				<section id="contenedor_center">
						...
						<div class="hijo-c2">
							...
							<br>
							<?php echo"<input type=\"text\" name=\"n_calle\" value=\"$fila[7]\" required>" ?>
							<br>
							<label>Calle:</label>
							<br>
							<?php echo"<input type=\"text\" name=\"calle\" size=\"20px\" title=\"Nombre de la calle\" value=\"$fila[8]\" required>" ?>
							<br>
							<label>Comuna:</label>
							<br>
							<?php echo"<input type=\"text\" name=\"comuna\" size=\"20px\" value=\"$fila[9]\" required>" ?>
						</div>
						<div class="hijo-c2">
							<h3>Informacion de contacto</h3>
							<label>Teléfono</label>
							<br>
							<?php echo"<input type=\"text\" name=\"fono\" size=\"20px\" title=\"Ingrese un numero de contacto\" value=\"$fila[5]\" required>" ?>
							<br>
							<label>Correo:</label>
							<br>
							<?php echo"<input type=\"text\" name=\"correo\" size=\"20px\" title=\"Ingrese correo\" value=\"$fila[6]\" required>" ?>
							<br>
