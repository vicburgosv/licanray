...
<html lang="es">
	...
	<body>
		<p>Estás seguro que deseas eliminar el registro del docente de rut: <?php echo"$rut"?> ?</p>
		<br>
		<?php 	echo"<form method=\"get\" action=\"accion/eliminar_docente.php\">";
				echo"<input type=\"hidden\" name=\"rut\" value=\"$rut\" >";
				echo"<td><input type=\"submit\" value=\"Sí, Eliminar\"></td>";
				echo"</form> ";
				echo"<form method=\"get\" action=\"../../menu_docente.html\">";
